...
PAPER_CLASSIFICATION_SCHEMA: Dict[str, Any] = {
    ...
    "json_schema": {
        ...
        "properties": {
            "labels": {
                "type": "object",
                "description": "Boolean labels indicating which categories the paper belongs to. A paper may have multiple true labels.",
                "properties": {
                    "is_prs": {
                        "type": "boolean",
                        "description": "True if paper develops, applies, evaluates, or reports Polygenic Risk Score (PRS/PGS/GRS) models. Includes papers with PRS performance metrics, PRS validation, or genetic risk prediction."
                    },
                    "is_heritability": {
                        "type": "boolean",
                        "description": "True if paper reports SNP-heritability (h²) estimates using methods like LDSC, GCTA, GREML, etc."
                    },
                    "is_genetic_correlation": {
                        "type": "boolean",
                        "description": "True if paper reports genetic correlation (rg) estimates between traits."
                    }
                },
                "required": ["is_prs", "is_heritability", "is_genetic_correlation"],
                "additionalProperties": False
            },
            "confidence": {
                "type": "object",
                "description": "Confidence scores (0.0-1.0) for each label.",
                "properties": {
                    "prs_confidence": {
                        "type": "number",
                        "description": "Confidence for is_prs label (0.0-1.0)."
                    },
                    "heritability_confidence": {
                        "type": "number",
                        "description": "Confidence for is_heritability label (0.0-1.0)."
                    },
                    "genetic_correlation_confidence": {
                        "type": "number",
                        "description": "Confidence for is_genetic_correlation label (0.0-1.0)."
                    }
                },
                "required": ["prs_confidence", "heritability_confidence", "genetic_correlation_confidence"],
                "additionalProperties": False
            },
            "evidence": {
                "type": "object",
                "description": "Key evidence from the abstract supporting each classification.",
                "properties": {
                    "prs_evidence": {
                        "type": "string",
                        "description": "Key phrases/terms supporting PRS classification, or empty if is_prs=false."
                    },
                    "heritability_evidence": {
                        "type": "string",
                        "description": "Key phrases/terms supporting heritability classification, or empty if is_heritability=false."
                    },
                    "genetic_correlation_evidence": {
                        "type": "string",
                        "description": "Key phrases/terms supporting genetic correlation classification, or empty if is_genetic_correlation=false."
                    }
                },
                "required": ["prs_evidence", "heritability_evidence", "genetic_correlation_evidence"],
                "additionalProperties": False
            },
            "reasoning": {
                "type": "string",
                "description": "Brief overall explanation of the classification decision."
            }
        },
        "required": [
            "labels",
                    ...
                    "properties": {
                        ...
                        "extraction_metadata": {
                            ...
                            "properties": {
                                ...
                                "source_text": {
                                    "type": "string",
                                    "description": "Verbatim quote from paper containing this data."
                                }
                            },
                    ...
                    "properties": {
                        ...
                        "heritability_estimate": {
                            ...
                            "properties": {
                                ...
                                "p_value": {
                                    "type": ["number", "null"],
                                    "description": "P-value for h² > 0 (statistical significance)."
                                },
                                "z_score": {
                                    "type": ["number", "null"],
                                    "description": "Z-statistics for h² estimate."
                                }
                            },
                            "required": ["h2", "se", "scale", "p_value", "z_score"],
                            "additionalProperties": False
                        },
                        "method": {
                            "type": "object",
                            "properties": {
                                ...
                                "intercept": {
                                    "type": ["number", "null"],
                                    "description": "LDSC intercept (distinguishes polygenicity from confounding)."
                                },
                                "lambda_gc": {
                                    "type": ["number", "null"],
                                    "description": "Genomic inflation factor (lambda GC)."
                                }
                            },
                            "required": ["estimation_method", "method_detail", "intercept", "lambda_gc"],
                            "additionalProperties": False
                        },
                        "population": {
                            "type": "object",
                        ...
                        "extraction_metadata": {
                            ...
                            "properties": {
                                ...
                                "source_text": {
                                    "type": "string",
                                    "description": "Verbatim quote from paper."
                                }
                            },
                            "required": ["confidence", "source_text"],
                            "additionalProperties": False
