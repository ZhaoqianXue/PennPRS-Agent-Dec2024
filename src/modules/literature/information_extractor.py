...
LLM-based extractors for structured data from paper abstracts:
        ...
        try:
            ...
            if self.SCHEMA:
                ...
                response = self.client.responses.create(
                    ...
                    input=messages
                    # Tools removed due to beta API issues
                )
            else:
                response = self.client.responses.create(
                    model=self.model_name,
            ...
            # Parse output from 'responses' object
            if hasattr(response, 'output'):
                 # Check for tool blocks in output list
                 content = ""
                 if isinstance(response.output, list):
                     ...
                     # If still no content, look for message content in other blocks (fallback already covered above)
                 else:
