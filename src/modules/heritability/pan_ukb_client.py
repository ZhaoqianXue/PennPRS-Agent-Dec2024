...
from src.modules.heritability.models import HeritabilityEstimate, HeritabilitySource, Population
...
class PanUKBClient:
    ...
    DEFAULT_DATA_PATH = Path("data/heritability/pan_ukb/pan_ukb_h2.tsv")
