...
- Respiratory and smoking-linked cancers/diseases: simple smoking-status adjustment can still be comparable evidence, but family history plus smoking interactions, PM2.5/environment bundles, spirometry-heavy packaging, or smoker-only framing should be treated as stronger penalties. If two direct-match candidates both involve smoking-related adjustment, prefer the one with simpler covariates and stronger disease-level PRS evidence.
