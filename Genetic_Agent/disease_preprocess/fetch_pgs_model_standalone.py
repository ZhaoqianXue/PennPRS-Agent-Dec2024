...
Usage:
    python fetch_pgs_model_standalone.py [PGS_ID]
...
Output:
    ...
    - Writes merged JSON to file (default: pgs_model_{PGS_ID}.json in current dir; override with -o)
"""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Write merged JSON to this file (default: pgs_model_{PGS_ID}.json in current dir)",
    )
