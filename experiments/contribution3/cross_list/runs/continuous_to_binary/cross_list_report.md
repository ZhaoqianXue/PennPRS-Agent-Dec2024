# Contribution3: Continuous-to-Binary Cross List Report (loinccode)
...
| Metric | Count |
|--------|-------|
| **Cross-list target traits** (retained Type A ∪ retained Type B) | **1** |
| — Retained Type A (Without Self incremental R2 + qualifying cross) | 0 |
| — Retained Type B (With Self incremental R2 + cross beats self) | 1 |
...
| — Type B self optimal | 31 |
| Any cross candidates | 1 |
...
|--------------|--------------|--------------------------|--------------------------|-------------|-----------------|-----------------|----------------|-------------------------|
| 1869-7 | apolipoprotein a 1 measurement | 0.01264 | 0.028918 | +0.0163 | M19 | arthritis | 17 | 12 |
...
| 1884-6 | apolipoprotein b measurement | 0.038225 | 4 |
