...
- **Total trials**: 90
- **Model**: gpt-5.2
- **Estimated API cost**: $1.3237 (uncached input 531,694 tokens = $0.9305; cached input 0 tokens = $0.0000; output 28,087 tokens = $0.3932)
- **Overall Recommended Model Accuracy**: 5/9 = 55.56%; `trial_hits = 47/90 = 52.22%`
- **Without Domain Knowledge**: 19/9 = 63.33%; `trial_hits = 190/300 = 63.33%`
...
|----------|----------|-------------|------------|-----------------------------------|-----------------------|--------------------------------------|--------------------------|
| prostate cancer | 96 | 1 | 0/10 | No | PGS005238 (AUC rank 51/96): x8<br>PGS004155 (AUC rank 30/96): x1<br>PGS004584 (AUC rank -): x1 | No | PGS005237 (AUC rank 72/96): x10 |
| thyroid carcinoma | 32 | 3 | 0/10 | No | PGS000208 (AUC rank 16/32): x10 | No | PGS001289 (AUC rank 24/32): x10 |
| hypothyroidism | 28 | 1 | 0/10 | No | PGS005218 (AUC rank 3/28): x4<br>PGS004935 (AUC rank 15/28): x4<br>PGS002766 (AUC rank 18/28): x2 | No | PGS005218 (AUC rank 3/28): x10 |
...
| obesity | 10 | 1 | 8/10 | Yes | PGS005235 (AUC rank 1/10): x8<br>PGS001298 (AUC rank 8/10): x1<br>PGS003400 (AUC rank 9/10): x1 | No | PGS001298 (AUC rank 8/10): x10 |
