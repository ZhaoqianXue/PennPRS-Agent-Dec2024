...
- **Total trials**: 300
- **Model**: gpt-5.2
- **Estimated API cost**: $1.6746 (uncached input 1,130,644 tokens = $0.9893; cached input 295,552 tokens = $0.0259; output 94,208 tokens = $0.6595)
- **Overall Recommended Model Accuracy**: 24/30 = 80.00%; `trial_hits = 235/300 = 78.33%`
...
| thyroid carcinoma | 32 | 3 | 0/10 | No | PGS000208 (AUC rank 16/32): x9<br>PGS000630 (AUC rank 14/32): x1 | No | PGS001289 (AUC rank 24/32): x10 |
...
| abdominal aortic aneurysm | 6 | 3 | 7/10 | Yes | PGS003972 (AUC rank 3/6): x7<br>PGS000753 (AUC rank 5/6): x3 | Yes | PGS003973 (AUC rank 1/6): x10 |
