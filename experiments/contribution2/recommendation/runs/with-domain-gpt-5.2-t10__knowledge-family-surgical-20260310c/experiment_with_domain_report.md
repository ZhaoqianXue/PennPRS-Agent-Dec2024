...
- **Total trials**: 300
- **Model**: gpt-5.2
- **Estimated API cost**: $1.2753 (uncached input 625,388 tokens = $0.5472; cached input 812,928 tokens = $0.0711; output 93,855 tokens = $0.6570)
- **Overall Recommended Model Accuracy**: 22/30 = 73.33%; `trial_hits = 221/300 = 73.67%`
...
| vitiligo | 3 | 1 | 0/10 | No | PGS001536 (AUC rank 3/3): x6<br>PGS000738 (AUC rank 2/3): x4 | No | PGS001536 (AUC rank 3/3): x10 |