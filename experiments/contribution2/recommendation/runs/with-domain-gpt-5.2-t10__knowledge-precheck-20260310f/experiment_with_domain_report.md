...
- **Total trials**: 100
- **Model**: gpt-5.2
- **Estimated API cost**: $1.4646 (uncached input 578,088 tokens = $1.0117; cached input 0 tokens = $0.0000; output 32,351 tokens = $0.4529)
- **Overall Recommended Model Accuracy**: 4/10 = 40.00%; `trial_hits = 43/100 = 43.00%`
...
| abdominal aortic aneurysm | 6 | 3 | 5/10 | No | PGS003972 (AUC rank 3/6): x4<br>PGS000753 (AUC rank 5/6): x4<br>PGS003973 (AUC rank 1/6): x1<br>PGS001784 (AUC rank 4/6): x1 | Yes | PGS003973 (AUC rank 1/6): x10 |
