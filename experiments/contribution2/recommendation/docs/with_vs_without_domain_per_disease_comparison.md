...
- With Domain Knowledge: `21/30 = 70.00%`; `trial_hits = 205/300 = 68.33%`
...
| --- | --- | --- | --- | --- | --- |
| Selected PGS ID | PGS000566 | PGS000333 | PGS005237 | PGS001291 | Agent Input |
| AoU benchmark rank | 1/95 | 37/95 | 72/95 | 18/95 | Benchmark Only |
| AoU benchmark AUC | 0.6550 | 0.5458 | 0.5205 | 0.5551 | Benchmark Only |
...
| phenotyping_reported | Cancer of prostate | Prostate cancer (incident and prevalent cases) | 5-year incident prostate cancer | Prostate cancer | Agent Input |
| method_name | PRS-CS | LDpred | SCT (Stacked Clumping and Thresholding) | snpnet | Agent Input |
| performance_metrics.auc | 0.5910 | 0.7880 | 0.8450 | 0.9701 | Agent Input |
| performance_metrics.r2 | N/A | N/A | N/A | 0.4016 | Agent Input |
| validation_sample_size | n=5,607 | n=91,106 | n=184,010 | n=67,425 | Agent Input |
| samples_training | n=5,650 | n=21,813 | n=10,000 | n=269,704 | Agent Input |
| ancestry_distribution | GWAS: EUR (100%) / DEV: EUR (100%) / EVAL: EUR (100%) | GWAS: EUR (100%) / DEV: EUR (100%) / EVAL: EUR (67%), MAE (33%) | GWAS: AFR (9%), AMR (3%), EAS (12%), EUR (76%) / DEV: EUR (100%) / EVAL: AFR (20%), EUR (60%), SAS (20%) | DEV: EUR (100%) / EVAL: AFR (20%), EAS (20%), EUR (40%), SAS (20%) | Agent Input |
| training_development_cohorts | MGI | FINRISK | UKB | UKB | Agent Input |
| publication.title | Cancer PRSweb: An Online Repository with Polygenic Risk Scores for Major Cancer Traits and Their Evaluation in Two Independent Biobanks. | Polygenic and clinical risk scores and their impact on age at onset and prediction of cardiometabolic diseases and common cancers. | Polygenic risk scores for prostate cancer: Comparative evaluations in UK and Australian cohorts. | Significant sparse polygenic risk scores across 813 traits in UK Biobank. | Agent Input |
| publication.journal | Am J Hum Genet | Nat Med | HGG Adv | PLoS Genet | Agent Input |
| date_release | 2020-12-15 | 2020-09-18 | 2025-10-06 | 2021-10-21 | Agent Input |
| variants_number | 1111494 | 6606785 | 517551 | 948 | Agent Input |
| covariates | age, sex, batch PCs 1-4 | genotyping array/batch, 10 ancestry PCs | - | age, sex, UKB array type, Genotype PCs | Agent Input |
...
| performance_metrics.auc | 0.6845 | 0.6135 | 0.6174 | 0.7510 | 0.8323 | 0.8323 | Agent Input |
| performance_metrics.r2 | N/A | N/A | N/A | N/A | 0.1670 | 0.1670 | Agent Input |
...
| phenotyping_reported | Hodgkin's disease | Chronic lymphocytic leukemia | Hodgkin's disease | Hodgkin's disease | Hodgkin's disease | Chronic lymphocytic leukemia | Agent Input |
...
| performance_metrics.auc | 0.6200 | N/A | 0.6010 | 0.6200 | 0.6200 | 0.8610 | Agent Input |
...
| Selection frequency | Benchmark target #1 | Benchmark target #2 | Benchmark target #3 | Benchmark target #4 | Benchmark target #5 | 10/10 trials | 10/10 trials | Rule-based baseline | Benchmark Only |
...
| performance_metrics.auc | 0.7870 | 0.6360 | 0.9816 | 0.6370 | 0.6560 | 0.7870 | 0.9816 | 0.9816 | Agent Input |
| performance_metrics.r2 | 0.6050 | N/A | 0.2970 | N/A | N/A | 0.6050 | 0.2970 | 0.2970 | Agent Input |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Selected PGS ID | PGS000075 | PGS000786 | PGS003381 | PGS002735 | PGS001795 | PGS001795 | PGS001299 | Agent Input |
| AoU benchmark rank | 1/14 | 2/14 | 3/14 | 4/14 | 9/14 | 9/14 | 10/14 | Benchmark Only |
| AoU benchmark AUC | 0.6120 | 0.6113 | 0.5970 | 0.5609 | 0.5044 | 0.5044 | 0.4564 | Benchmark Only |
| In Target_TopK | Yes | Yes | Yes | Yes | No | No | No | Benchmark Only |
| Selection frequency | Benchmark target #1 | Benchmark target #2 | Benchmark target #3 | Benchmark target #4 | 9/10 trials | 10/10 trials | Rule-based baseline | Benchmark Only |
| trait_reported | Endometrial cancer | Endometrial cancer | Uterine endometrial carcinoma | Endometrial cancer | Uterine cancer | Uterine cancer | Cervical cancer | Agent Input |
| trait_efo | endometrial carcinoma | endometrial carcinoma | endometrial carcinoma | endometrial carcinoma | uterine carcinoma | uterine carcinoma | cervical carcinoma | Agent Input |
| phenotyping_reported | Endometrial cancer | Incident endometrial cancer | uterine endometrial carcinoma | Risk of endometrial cancer | Uterine cancer | Uterine cancer | Cervical cancer | Agent Input |
| method_name | Genome-wide significant variants | 9 variants from Graff et al (PGS000075) with inverse variant weights | lassosum | Genome-wide significant variants | PRS-CS-auto | PRS-CS-auto | snpnet | Agent Input |
| performance_metrics.auc | 0.7550 | 0.7540 | 0.7610 | 0.5600 | 0.6600 | 0.6600 | 0.9143 | Agent Input |
| performance_metrics.r2 | N/A | 0.4860 | 0.1100 | N/A | N/A | N/A | 0.2202 | Agent Input |
| validation_sample_size | n=221,699 | n=212,156 | n=144,479 | n=118,636 | n=170,276 | n=170,276 | n=67,425 | Agent Input |
| samples_training | N/A | N/A | N/A | n=1,757 | N/A | N/A | n=269,704 | Agent Input |
| ancestry_distribution | GWAS: NR (34%), EUR (66%) / EVAL: EUR (100%) | GWAS: NR (34%), EUR (66%) / EVAL: EUR (100%) | GWAS: EUR (100%) / EVAL: EUR (100%) | GWAS: NR (100%) / DEV: EUR (100%) / EVAL: EUR (100%) | GWAS: EAS (15%), EUR (84%), OTH (80%) / EVAL: EUR (100%) | GWAS: EAS (15%), EUR (84%), OTH (80%) / EVAL: EUR (100%) | DEV: EUR (100%) / EVAL: AFR (20%), EAS (20%), EUR (40%), SAS (20%) | Agent Input |
| training_development_cohorts | N/A | ANECS B58C CoRGI E2C2 HCS NBBS NSECG QIMR SEARCH WTCCC | N/A | N/A | BBJ BioMe BioVU CCPM CKB EB FinnGen HUNT MGBB MGI deCODE | BBJ BioMe BioVU CCPM CKB EB FinnGen HUNT MGBB MGI deCODE | UKB | Agent Input |
...
| publication.journal | Nat Commun | Nat Commun | Cancer Res | Genet Med | Cell Genom | Cell Genom | PLoS Genet | Agent Input |
| date_release | 2020-02-12 | 2021-05-28 | 2023-01-19 | 2022-07-21 | 2022-09-08 | 2022-09-08 | 2021-10-21 | Agent Input |
| variants_number | 9 | 9 | 529365 | 19 | 911692 | 911692 | 24 | Agent Input |
| covariates | Genotyping reagent kit (GERA cohort only), genotyping array (UK Biobank only), age, 10 PCs. | Age at assessment, family history of cancer, genotyping array, PCs(1-15), parity ( ≥1 live birth vs. none), age at menarche, body mass index, Menopausal status (pre-menopausal vs. post-menopausal vs. unknown or hysterectomy), ever used hormone replacement therapy, oral contraceptive use (never used (0) vs. <20 years vs. ≥20 years), | age, top 20 genetic principal components | Unknown | sex,age,age2,age*sex,age^2*sex, 20PCs | sex,age,age2,age*sex,age^2*sex, 20PCs | age, sex, UKB array type, Genotype PCs | Agent Input |
...
| Field | Target #1 | With Domain Knowledge | Without Domain Knowledge | Baseline | Field Type |
| --- | --- | --- | --- | --- | --- |
| Selected PGS ID | PGS005235 | PGS004447 | PGS001298 | PGS001298 | Agent Input |
| AoU benchmark rank | 1/10 | 6/10 | 8/10 | 8/10 | Benchmark Only |
| AoU benchmark AUC | 0.6311 | 0.5611 | 0.5549 | 0.5549 | Benchmark Only |
| In Target_TopK | Yes | No | No | No | Benchmark Only |
| Selection frequency | Benchmark target #1 | 6/10 trials | 10/10 trials | Rule-based baseline | Benchmark Only |
| trait_reported | Adiposity | E66 (Obesity) | Obesity (time-to-event) | Obesity (time-to-event) | Agent Input |
| trait_efo | obesity | obesity | obesity | obesity | Agent Input |
| phenotyping_reported | Obesity (phecode: 278.1) | E66 (Obesity) | TTE obesity | TTE obesity | Agent Input |
| method_name | LDpred2-auto | LDpred2 | snpnet | snpnet | Agent Input |
| performance_metrics.auc | N/A | N/A | 0.6533 | 0.6533 | Agent Input |
| performance_metrics.r2 | N/A | N/A | 0.0423 | 0.0423 | Agent Input |
| validation_sample_size | n=100,960 | n=56,192 | n=67,425 | n=67,425 | Agent Input |
| samples_training | N/A | n=174,489 | n=269,704 | n=269,704 | Agent Input |
| ancestry_distribution | GWAS: EUR (100%) / EVAL: EUR (100%) | DEV: EUR (100%) / EVAL: EUR (100%) | DEV: EUR (100%) / EVAL: AFR (20%), EAS (20%), EUR (40%), SAS (20%) | DEV: EUR (100%) / EVAL: AFR (20%), EAS (20%), EUR (40%), SAS (20%) | Agent Input |
| training_development_cohorts | EGG GIANT UKB | UKB | UKB | UKB | Agent Input |
| publication.title | Modeling the genomic architecture of adiposity and anthropometrics across the lifespan. | Integration of risk factor polygenic risk score with disease polygenic risk score for disease prediction. | Significant sparse polygenic risk scores across 813 traits in UK Biobank. | Significant sparse polygenic risk scores across 813 traits in UK Biobank. | Agent Input |
| publication.journal | Nat Commun | Commun Biol | PLoS Genet | PLoS Genet | Agent Input |
| date_release | 2025-10-06 | 2024-03-18 | 2021-10-21 | 2021-10-21 | Agent Input |
| variants_number | 709828 | 1059939 | 9227 | 9227 | Agent Input |
| covariates | age, sex, batch, and the first 10 genetic principal components | Unknown | age, sex, UKB array type, Genotype PCs | age, sex, UKB array type, Genotype PCs | Agent Input |
...
| performance_metrics.auc | N/A | 0.9891 | 0.9915 | 0.9891 | 0.9915 | 0.9915 | Agent Input |
| performance_metrics.r2 | N/A | 0.4432 | 0.4486 | 0.4432 | 0.4486 | 0.4486 | Agent Input |
...
| Field | Target #1 | Target #2 | Target #3 | With Domain Knowledge | Without Domain Knowledge | Baseline | Field Type |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Selected PGS ID | PGS005254 | PGS005255 | PGS005256 | PGS005252 | PGS005252 | PGS005252 | Agent Input |
| AoU benchmark rank | 1/8 | 2/8 | 3/8 | 8/8 | 8/8 | 8/8 | Benchmark Only |
| AoU benchmark AUC | 0.6375 | 0.6233 | 0.6228 | 0.3445 | 0.3445 | 0.3445 | Benchmark Only |
| In Target_TopK | Yes | Yes | Yes | No | No | No | Benchmark Only |
| Selection frequency | Benchmark target #1 | Benchmark target #2 | Benchmark target #3 | 10/10 trials | 10/10 trials | Rule-based baseline | Benchmark Only |
...
| phenotyping_reported | incident aortic stenosis | incident aortic stenosis | incident aortic stenosis | Incident aortic stenosis cases | Incident aortic stenosis cases | Incident aortic stenosis cases | Agent Input |
| method_name | PRS-CS | PRS-CS | PRS-CS | LDPred2 | LDPred2 | LDPred2 | Agent Input |
| performance_metrics.auc | N/A | N/A | N/A | 0.8700 | 0.8700 | 0.8700 | Agent Input |
| performance_metrics.r2 | N/A | N/A | N/A | N/A | N/A | N/A | Agent Input |
| validation_sample_size | n=244,450 | n=244,450 | n=244,450 | n=446,895 | n=446,895 | n=446,895 | Agent Input |
| samples_training | n=205,483 | n=98,645 | n=96,385 | n=47,691 | n=47,691 | n=47,691 | Agent Input |
...
| training_development_cohorts | N/A | N/A | N/A | MGBB | MGBB | MGBB | Agent Input |
...
| variants_number | 1110912 | 1111632 | 1111632 | 1119377 | 1119377 | 1119377 | Agent Input |
...
| performance_metrics.auc | 0.6637 | 0.6652 | 0.6652 | 0.6652 | 0.7429 | Agent Input |
| performance_metrics.r2 | N/A | N/A | N/A | N/A | 0.0808 | Agent Input |
...
| performance_metrics.auc | 0.5876 | 0.5933 | 0.5933 | 0.5933 | 0.6174 | Agent Input |
...
| Field | Target #1 | Target #2 | Target #3 | Target #4 | With Domain Knowledge | Without Domain Knowledge | Baseline | Field Type |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Selected PGS ID | PGS001278 | PGS001280 | PGS001277 | PGS001279 | PGS001279 | PGS001280 | PGS001279 | Agent Input |
| AoU benchmark rank | 1/7 | 2/7 | 3/7 | 4/7 | 4/7 | 2/7 | 4/7 | Benchmark Only |
| AoU benchmark AUC | 0.5943 | 0.5916 | 0.5907 | 0.5885 | 0.5885 | 0.5916 | 0.5885 | Benchmark Only |
| In Target_TopK | Yes | Yes | Yes | Yes | Yes | Yes | Yes | Benchmark Only |
| Selection frequency | Benchmark target #1 | Benchmark target #2 | Benchmark target #3 | Benchmark target #4 | 10/10 trials | 7/10 trials | Rule-based baseline | Benchmark Only |
| trait_reported | previously: Blood clot in the leg (DVT) or lung | PE (time-to-event) | PE +/- DVT | previously: Blood clot in the lung | previously: Blood clot in the lung | PE (time-to-event) | previously: Blood clot in the lung | Agent Input |
| trait_efo | pulmonary embolism, deep vein thrombosis | pulmonary embolism | pulmonary embolism, deep vein thrombosis | pulmonary embolism, deep vein thrombosis | pulmonary embolism, deep vein thrombosis | pulmonary embolism | pulmonary embolism, deep vein thrombosis | Agent Input |
| phenotyping_reported | Blood clot in the leg (DVT) or lung | TTE PE | PE +/- DVT | Blood clot in the lung | Blood clot in the lung | TTE PE | Blood clot in the lung | Agent Input |
| method_name | snpnet | snpnet | snpnet | snpnet | snpnet | snpnet | snpnet | Agent Input |
| performance_metrics.auc | 0.6674 | 0.8074 | 0.8083 | 0.8256 | 0.8256 | 0.8074 | 0.8256 | Agent Input |
| performance_metrics.r2 | 0.0364 | 0.1233 | 0.1233 | 0.1674 | 0.1674 | 0.1233 | 0.1674 | Agent Input |
| validation_sample_size | n=67,349 | n=67,425 | n=67,425 | n=67,349 | n=67,349 | n=67,425 | n=67,349 | Agent Input |
| samples_training | n=269,382 | n=269,704 | n=269,704 | n=269,382 | n=269,382 | n=269,704 | n=269,382 | Agent Input |
...
| variants_number | 551 | 88 | 96 | 94 | 94 | 88 | 94 | Agent Input |
...
| Field | Target #1 | Target #2 | Target #3 | With Domain Knowledge | Without Domain Knowledge | Baseline | Field Type |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Selected PGS ID | PGS003973 | PGS003429 | PGS003972 | PGS003973 | PGS003973 | PGS003973 | Agent Input |
| AoU benchmark rank | 1/6 | 2/6 | 3/6 | 1/6 | 1/6 | 1/6 | Benchmark Only |
| AoU benchmark AUC | 0.6374 | 0.6341 | 0.6312 | 0.6374 | 0.6374 | 0.6374 | Benchmark Only |
| In Target_TopK | Yes | Yes | Yes | Yes | Yes | Yes | Benchmark Only |
| Selection frequency | Benchmark target #1 | Benchmark target #2 | Benchmark target #3 | 10/10 trials | 10/10 trials | Rule-based baseline | Benchmark Only |
...
| performance_metrics.auc | 0.8820 | 0.7080 | 0.6900 | 0.8820 | 0.8820 | 0.8820 | Agent Input |
| performance_metrics.r2 | N/A | 0.0055 | N/A | N/A | N/A | N/A | Agent Input |
| validation_sample_size | n=7,517 | n=91,731 | n=7,324 | n=7,517 | n=7,517 | n=7,517 | Agent Input |
...
| training_development_cohorts | ARIC CHB CHIP HUNT MAYO-VDB MGI MVP MyCode NZ PMB TABS deCODE eMERGE | UKB | ARIC CHB CHIP HUNT MAYO-VDB MGI MVP MyCode NZ PMB TABS UKAGS UKB VIVA deCODE eMERGE | ARIC CHB CHIP HUNT MAYO-VDB MGI MVP MyCode NZ PMB TABS deCODE eMERGE | ARIC CHB CHIP HUNT MAYO-VDB MGI MVP MyCode NZ PMB TABS deCODE eMERGE | ARIC CHB CHIP HUNT MAYO-VDB MGI MVP MyCode NZ PMB TABS deCODE eMERGE | Agent Input |
...
| covariates | Age, Age^2, Sex | Unknown | Unknown | Age, Age^2, Sex | Age, Age^2, Sex | Age, Age^2, Sex | Agent Input |
...
| phenotyping_reported | Age-related macular degeneration | Rentinal layer thickness (photoreceptor inner and outer segments) | Early age-related macular degeneration (Clinical Classification) | Age-related macular degeneration | Age-related macular degeneration | Early age-related macular degeneration (Clinical Classification) | Agent Input |
...
| performance_metrics.auc | 0.7100 | N/A | 0.8420 | 0.7100 | 0.7100 | 0.8420 | Agent Input |
| performance_metrics.r2 | N/A | N/A | N/A | N/A | N/A | N/A | Agent Input |
| validation_sample_size | n=163,011 | n=44,823 | n=1,780 | n=163,011 | n=163,011 | n=1,780 | Agent Input |
| samples_training | N/A | N/A | N/A | N/A | N/A | N/A | Agent Input |
...
| Field | Target #1 | With Domain Knowledge | Without Domain Knowledge | Baseline | Field Type |
| --- | --- | --- | --- | --- | --- |
| Selected PGS ID | PGS000054 | PGS000334 | PGS004918 | PGS004918 | Agent Input |
| AoU benchmark rank | 1/5 | 3/5 | 4/5 | 4/5 | Benchmark Only |
| AoU benchmark AUC | 0.5690 | 0.5144 | 0.5114 | 0.5114 | Benchmark Only |
| In Target_TopK | Yes | No | No | No | Benchmark Only |
| Selection frequency | Benchmark target #1 | 10/10 trials | 6/10 trials | Rule-based baseline | Benchmark Only |
| trait_reported | Alzheimer's disease (late onset) | Late-onset Alzheimer’s disease | Late-onset Alzheimers disease (based on SNPs in genes involved in synaptic function) | Late-onset Alzheimers disease (based on SNPs in genes involved in synaptic function) | Agent Input |
...
| performance_metrics.auc | N/A | N/A | 0.7310 | 0.7310 | Agent Input |
| performance_metrics.r2 | N/A | 0.1910 | N/A | N/A | Agent Input |
| validation_sample_size | n=3,324 | n=5,347 | n=136 | n=136 | Agent Input |
| samples_training | N/A | N/A | n=439 | n=439 | Agent Input |
| ancestry_distribution | GWAS: EUR (100%) / EVAL: AMR (100%) | GWAS: NR (19%), EUR (81%) / EVAL: EUR (100%) | GWAS: EUR (100%) / DEV: EUR (100%) / EVAL: EUR (100%) | GWAS: EUR (100%) / DEV: EUR (100%) / EVAL: EUR (100%) | Agent Input |
| training_development_cohorts | ACT ADC ADNI AGES CHS EADI FHS GERAD GSK LOAD MAYO MIRAGE OHSU ROSMAP RS TGEN UMVUMSS UPITT WASHU | IGAP UKB | ADGC BfDR CHARGE EADI GERAD | ADGC BfDR CHARGE EADI GERAD | Agent Input |
| publication.title | Polygenic risk scores in familial Alzheimer disease. | Risk prediction of late-onset Alzheimer's disease implies an oligogenic architecture. | Genetic variants in glutamate-, Aβ-, and tau-related pathways determine polygenic risk for Alzheimer's disease. | Genetic variants in glutamate-, Aβ-, and tau-related pathways determine polygenic risk for Alzheimer's disease. | Agent Input |
| publication.journal | Neurology | Nat Commun | Neurobiol Aging | Neurobiol Aging | Agent Input |
| date_release | 2019-12-18 | 2020-10-16 | 2024-06-12 | 2024-06-12 | Agent Input |
| variants_number | 21 | 22 | 8 | 8 | Agent Input |
...
| performance_metrics.auc | 0.8000 | 0.8210 | 0.7300 | 0.8000 | 0.8000 | 0.8210 | Agent Input |
| performance_metrics.r2 | 0.0480 | N/A | 0.0310 | 0.0480 | 0.0480 | N/A | Agent Input |
...
| covariates | age, age^2, sex, PC1-10 | Age, gender, PCs(1-10) | age, age^2, sex, PC1-10 | age, age^2, sex, PC1-10 | age, age^2, sex, PC1-10 | Age, gender, PCs(1-10) | Agent Input |
...
| Selection frequency | Benchmark target #1 | 6/10 trials | 9/10 trials | Rule-based baseline | Benchmark Only |
...
| phenotyping_reported | Incident and prevelant peripheral artery disease | Incident and prevelant peripheral artery disease | Peripheral vascular disease, unspecified | Incident and prevelant peripheral artery disease | Agent Input |
| method_name | LDpred2 | LDpred2 | Penalized regression (bigstatsr) | LDpred2 | Agent Input |
| performance_metrics.auc | 0.7310 | 0.7310 | N/A | 0.7310 | Agent Input |
| performance_metrics.r2 | 0.3166 | 0.3166 | N/A | 0.3166 | Agent Input |
...
| In Target_TopK | Yes | Yes | No | No | No | Benchmark Only |
| Selection frequency | Benchmark target #1 | Benchmark target #2 | 10/10 trials | 10/10 trials | Rule-based baseline | Benchmark Only |
