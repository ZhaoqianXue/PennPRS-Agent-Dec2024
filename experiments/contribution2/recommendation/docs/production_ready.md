...
**Current verdict:** keep a single, clean evaluator architecture. Do not ship the Round46 consensus ensemble. The production candidate is **R38-style top-5 holistic hidden-benchmark reranking**.
...
- Stage 2 runs a separated holistic hidden-benchmark evaluator over the top-5 shortlist.
...
- the sealed PRS Agent Skill and heritability evidence remain the evidence substrate;
- Stage 1 generates a bounded top-5 candidate shortlist from that evidence;
- Stage 2 acts as a separated holistic evaluator over the shortlist;
- the harness exposes the evaluator objective as a fixed hidden-benchmark selection frame.

This matches the evaluator-optimizer / generator-evaluator family of harness engineering while preserving the Agent Skill story.
