...
| --- | --- | --- | --- | --- | --- |
| Selected PGS ID | PGS001824 | PGS002032 | PGS000924 | PGS001824 | Agent Input |
| AoU benchmark rank | 1/3 | 2/3 | 3/3 | 1/3 | Benchmark Only |
| AoU benchmark AUC | 0.7228 | 0.7206 | 0.7166 | 0.7228 | Benchmark Only |
...
| method_name | Penalized regression (bigstatsr) | LDpred2 (bigsnpr) | snpnet | Penalized regression (bigstatsr) | Agent Input |
| performance_metrics.selected_performance_id | PPM009490 | PPM011128 | PPM007451 | PPM009490 | Agent Input |
...
| variants_number | 22 | 19768 | 5 | 22 | Agent Input |
