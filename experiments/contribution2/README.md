...
| `disease_selection/runs/selected_diseases_contribution2_current_union__75disease.csv` | Canonicalized current-method union; directly usable by recommendation ground-truth generation without manual `Target_TopK` annotation |
...
| `disease_selection/runs/intermediate/selected_diseases_contribution2_current_union_details__75disease.csv` | Audit/detail view for canonical merge decisions and source coverage |
...
# Current 75-disease canonical union
python experiments/contribution2/recommendation/configs/generate_evaluated_pgs_list.py \
...
- plus one extra Markdown report comparing `With Domain Knowledge` vs the matching archived `without-domain-gpt-5.2-t10__30disease` or `without-domain-gpt-5.2-t10__75disease` run
...
# Current 75-disease canonical union (comparison defaults to the matching without-domain run)
python experiments/contribution2/recommendation/scripts/run_experiment_with_domain.py \
  --union-csv experiments/contribution2/disease_selection/runs/selected_diseases_contribution2_current_union__75disease.csv
...
- `recommendation/docs/without_domain_per_disease_comparison__75disease.md`
- `recommendation/docs/with_vs_without_domain_per_disease_comparison__75disease.md`
