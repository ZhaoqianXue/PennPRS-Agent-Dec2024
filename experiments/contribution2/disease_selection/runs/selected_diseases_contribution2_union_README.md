...
For the current auto-generated canonical union, use `selected_diseases_contribution2_current_union__76disease.csv`. The numeric suffix is now intended to track the actual current disease count.
...
1. Run `python experiments/contribution2/recommendation/configs/generate_evaluated_pgs_list.py` (requires Contribution1 result files) to produce `recommendation/runs/ground-truth__contribution1/evaluated_pgs_per_ontology.json`.
...
| `../recommendation/runs/ground-truth__contribution1/evaluated_pgs_per_ontology.json` | Evaluated PGS IDs per ontology for the frozen 30-disease benchmark (generated by recommendation configs) |
